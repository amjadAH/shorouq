import svgPaths from "./svg-p07dx5ouu6";
...
function IcQrcode() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ic_qrcode">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ic_qrcode">
...
function Frame25() {
  return (
    <div className="bg-[#f2f5ff] content-stretch flex items-start p-[10px] relative rounded-[8px] shrink-0">
      <IcCameraplus />
    </div>
  );
}
...
function IdUpload2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-[250px] items-center justify-center min-h-px min-w-px relative rounded-[16px]" data-name="ID Upload">
      <div aria-hidden="true" className="absolute border-2 border-[#b3b5ba] border-dashed inset-0 pointer-events-none rounded-[16px]" />
      <Frame25 />
      <p className="font-['Tajawal:Bold',sans-serif] leading-[0] not-italic relative shrink-0 text-[#242938] text-[0px] text-[18px] text-right" dir="auto">
        <span className="leading-none">{`اضف الصورة الخلفية `}</span>
        <span className="font-['Tajawal:Regular',sans-serif] leading-none text-[#5e6167]">لبيانات العميل</span>
      </p>
    </div>
  );
}
...
export default function ClientInfo2CardInfo() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Client info 2 + Card info">
      <Courier />
      <Courier1 />
      <Courier2 />
      <Header />
