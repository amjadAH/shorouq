import svgPaths from "./svg-0pa8f9wnvn";
...
export default function ClientInfoNewClient() {
  return (
    <div className="bg-white relative size-full" data-name="Client info ( new client )">
      <Frame8 />
      <Frame10 />
      <Header />
    </div>
