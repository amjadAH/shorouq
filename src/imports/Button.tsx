function HomePage() {
  return (
    <div className="relative w-full" data-name="HomePage">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic text-[#ff9f7a] text-[16px] text-center tracking-[-0.3125px] whitespace-nowrap">{`View Systems & Foundations`}</p>
    </div>
  );
}
