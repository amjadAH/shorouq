...
function Paragraph() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[868px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[26px] left-0 not-italic text-[#b5b5b5] text-[16px] top-0 tracking-[-0.3125px] w-[868px] whitespace-pre-wrap">Screens are shown in Arabic as the product serves a local market. Design decisions focus on hierarchy, flow, and system feedback.</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="bg-[rgba(255,159,122,0.03)] h-[98px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
      ...
      <div className="content-stretch flex flex-col items-start pl-[28px] pr-[4px] py-[24px] relative size-full">
        <Paragraph />
      </div>
    </div>
  );
...
function Paragraph1() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#a0a0a0] text-[18px] top-0 tracking-[-0.4395px] w-[899px] whitespace-pre-wrap">Designed for fast, on-the-go interactions — making referral tracking and sharing intuitive, transparent, and action-driven.</p>
      </div>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start pt-[49px] relative shrink-0 w-full" data-name="Container">
