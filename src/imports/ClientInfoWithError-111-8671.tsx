import svgPaths from "./svg-n4ca8s7bzx";
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-right">
      <p className="font-['Tajawal:Bold',sans-serif] leading-[0] relative shrink-0 text-[#242938] text-[0px] text-[18px]" dir="auto">
        <span className="leading-none">{`اضف `}</span>
        <span className="leading-none">{`الصورة الخلفية `}</span>
        <span className="font-['Tajawal:Regular',sans-serif] leading-none text-[#5e6167]">لبطاقة الرقم القومي</span>
      </p>
      <p className="font-['Tajawal:Medium',sans-serif] leading-none relative shrink-0 text-[#dd2c46] text-[16px]" dir="auto">
        تأكد من إضافة الصورة الخلفية للبطاقة
      </p>
    </div>
  );
}
...
function IdUpload() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[264px] items-center justify-center relative rounded-[16px] shrink-0 w-[376px]" data-name="ID Upload">
      <div aria-hidden="true" className="absolute border-2 border-[#dd2c46] border-dashed inset-0 pointer-events-none rounded-[16px]" />
      <Frame9 />
      <Frame10 />
    </div>
  );
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-right">
      <p className="font-['Tajawal:Bold',sans-serif] leading-[0] relative shrink-0 text-[#242938] text-[0px] text-[18px]" dir="auto">
        <span className="leading-none">{`اضف `}</span>
        <span className="leading-none">{`الصورة الأمامية `}</span>
        <span className="font-['Tajawal:Regular',sans-serif] leading-none text-[#5e6167]">لبطاقة الرقم القومي</span>
      </p>
      <p className="font-['Tajawal:Medium',sans-serif] leading-none relative shrink-0 text-[#dd2c46] text-[16px]" dir="auto">
        تأكد من إضافة الصورة الأمامية للبطاقة
      </p>
    </div>
  );
}
