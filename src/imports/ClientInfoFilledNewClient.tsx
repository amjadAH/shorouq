import svgPaths from "./svg-mwcywemc3x";
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-end justify-center relative shrink-0">
      <Tags />
      <Frame10 />
    </div>
  );
...
export default function ClientInfoFilledNewClient() {
  return (
    <div className="bg-white relative size-full" data-name="Client info ( filled new client )">
      <Frame7 />
      <Frame6 />
      <Header />
    </div>
