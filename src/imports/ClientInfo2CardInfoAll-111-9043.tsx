import svgPaths from "./svg-f8hfwtde0l";
...
import imgIdUpload2 from "figma:asset/785ad222d2e40f5750bbc8f35eabb74e7ac41a76.png";
import imgIdUpload3 from "figma:asset/c91f8e425b1dcb513ce5a6fcef46f88a9e2458ab.png";
import imgIdUpload4 from "figma:asset/93406ec1c742decb80d1f0a06f42910eea45977e.png";
...
function IcLock() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ic_lock">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="lock-01">
          <path d={svgPaths.p1f362000} id="Icon" stroke="var(--stroke-0, #242938)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-center left-[160px] top-[157px] w-[1600px]">
      <Frame6 />
    </div>
  );
}
...
function Courier() {
  return (
    <div className="bg-white h-[1080px] overflow-clip relative shrink-0 w-[1920px]" data-name="courier">
      <Frame14 />
    </div>
  );
}
...
function Frame41() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-end justify-center leading-none min-h-px min-w-px not-italic relative text-right">
      <p className="font-['Tajawal:Regular',sans-serif] relative shrink-0 text-[#6b6f79] text-[12px]" dir="auto">
        الاسم الأخير
      </p>
      <p className="font-['Tajawal:Bold',sans-serif] relative shrink-0 text-[#242938] text-[14px] w-[155px] whitespace-pre-wrap" dir="auto">
        صلاح محمود علي
      </p>
    </div>
  );
...
function Base() {
  return (
    <div className="content-stretch flex gap-[8px] h-[48px] items-center p-[16px] relative rounded-[4px] shrink-0 w-[328px]" data-name="base">
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col h-[48px] items-end justify-between relative shrink-0">
      <Base />
    </div>
  );
}
...
function IcChevrondown() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ic_chevrondown">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ic_chevrondown">
          <path d="M6 9L12 15L18 9" id="Icon" stroke="var(--stroke-0, #B3B5BA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Frame39() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-end justify-center leading-none min-h-px min-w-px not-italic relative text-right">
      <p className="font-['Tajawal:Regular',sans-serif] relative shrink-0 text-[#5e6167] text-[12px]" dir="auto">
        المنطقة
      </p>
      <p className="font-['Tajawal:Bold',sans-serif] relative shrink-0 text-[#b3b5ba] text-[14px] w-[169px] whitespace-pre-wrap" dir="auto">
        المنيب
      </p>
    </div>
  );
...
function Base2() {
  return (
    <div className="content-stretch flex gap-[8px] h-[48px] items-center p-[16px] relative rounded-[4px] shrink-0 w-[328px]" data-name="base">
      <div aria-hidden="true" className="absolute border border-[#dfe0e2] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <IcChevrondown />
      <Frame39 />
    </div>
  );
...
function QrCode() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="qr-code-02">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ic_qrcode">
          <path d={svgPaths.p17230b00} id="Icon" stroke="var(--stroke-0, #3366FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function TextCta2() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center justify-center right-[-0.33px] top-[276px]" data-name="Text CTA">
      <p className="font-['Tajawal:Bold',sans-serif] leading-none not-italic relative shrink-0 text-[#242938] text-[18px] text-right" dir="auto">
        تغير الصورة
      </p>
      <IcRefresh />
...
function IdUpload2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[264px] items-end justify-center min-h-px min-w-px relative rounded-[16px]" data-name="ID Upload">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[16px] size-full" src={imgIdUpload2} />
      <TextCta2 />
    </div>
  );
}
...
function IdUpload3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[264px] items-end justify-center min-h-px min-w-px relative rounded-[16px]" data-name="ID Upload">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[16px] size-full" src={imgIdUpload3} />
      <TextCta3 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[264px] items-end justify-center min-h-px min-w-px relative rounded-[16px]" data-name="ID Upload">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[16px]">
        <img alt="" className="absolute h-[219.53%] left-0 max-w-none top-[-23.87%] w-full" src={imgIdUpload4} />
      </div>
      <TextCta4 />
    </div>
  );
...
function Frame27() {
  return (
    <div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-[1368px]">
      <IdUpload2 />
      <IdUpload3 />
      <IdUpload4 />
    </div>
...
function Frame19() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#dfe0e2] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <div className="flex flex-col items-end size-full">
        <div className="content-stretch flex flex-col items-end p-[48px] relative w-full">
          <Frame20 />
        </div>
      </div>
    </div>
...
function Frame25() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[160px] top-[962px] w-[512px]">
      <Buttons />
      <TextCta5 />
    </div>
  );
...
export default function ClientInfo2CardInfoAll() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Client info 2 + Card info ( all )">
      <Courier />
      <Courier1 />
      <Courier2 />
      <Header />
